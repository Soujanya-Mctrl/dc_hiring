...
export const prepareDCHiringRow = (formData: any) => {
  return {
    ...
    'Other Interest': formData.otherInterest || '',
    'Development Selections': Array.isArray(formData.developmentSelections) ? formData.developmentSelections.join(', ') : '',
    'Resume Filename': formData.resumeFilename || '',
    'Resume FileId': formData.resumeFileId || '',
