...
export function SplitLayout({ children }: SplitLayoutProps) {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#0A0A0A] text-white">
      {/* Left Branding Panel */}
      <div className="relative w-full lg:w-[45%] flex flex-col p-8 lg:p-16 lg:fixed lg:h-screen lg:left-0 lg:top-0 border-r border-[#141414]/50 overflow-hidden">
        {/* Background Graphic Approximation (Subtle Green radial gradient and dotted pattern) */}
        ...
        <div className="grid grid-cols-4 gap-4 z-10">
          <div>
            <div className="text-[#00C652] mb-2">
